...
Welcome to your new DLL mod, you should see you now have a `SM-LuaConsole.sln` file, all the files you see here were generated from the template.

## Usage

1. Clone this repository locally
2. Open the `SM-LuaConsole.sln` file in Visual Studio
...
6. You can then view the https://github.com/ScrappySM/SM-LuaConsole/releases to see your mod's release page, edit the draft and publish it when you are ready.
